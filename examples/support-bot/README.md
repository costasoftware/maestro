...
Same `@costasoftware/maestro-core` package backs all three — the variability lives entirely in the host's ctx, ports, and route handlers.
...
pnpm --filter @costasoftware/maestro-example-support-bot dev
```
